...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SnykCvssDetails) DeepCopyInto(out *SnykCvssDetails) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SnykCvssDetails.
func (in *SnykCvssDetails) DeepCopy() *SnykCvssDetails {
	if in == nil {
		return nil
	}
	out := new(SnykCvssDetails)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SnykReport) DeepCopyInto(out *SnykReport) {
	*out = *in
	if in.Vulnerabilities != nil {
		in, out := &in.Vulnerabilities, &out.Vulnerabilities
		*out = make([]SnykVulnerability, len(*in))
		for i := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SnykReport.
func (in *SnykReport) DeepCopy() *SnykReport {
	if in == nil {
		return nil
	}
	out := new(SnykReport)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SnykVulnerability) DeepCopyInto(out *SnykVulnerability) {
	*out = *in
	if in.CvssDetails != nil {
		in, out := &in.CvssDetails, &out.CvssDetails
		*out = make([]SnykCvssDetails, len(*in))
		copy(*out, *in)
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SnykVulnerability.
func (in *SnykVulnerability) DeepCopy() *SnykVulnerability {
	if in == nil {
		return nil
	}
	out := new(SnykVulnerability)
	in.DeepCopyInto(out)
	return out
}
