...
import (
	...
	aquasecuritygithubiov1alpha1 "github.com/mkm29/report-operator/api/v1alpha1"
	"github.com/mkm29/report-operator/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "dcb5f47e.mitchmurphy.io",
